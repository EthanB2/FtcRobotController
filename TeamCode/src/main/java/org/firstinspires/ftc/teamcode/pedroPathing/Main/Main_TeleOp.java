...
//            extendMotor.setPower(0);
        ...
        while (opModeIsActive()) {
            ...
            double leftFrontPower = motorSpeed*(axial + lateral + yaw);
            double rightFrontPower = motorSpeed*(axial - lateral - yaw);
            double leftBackPower = motorSpeed*(axial - lateral + yaw);
            double rightBackPower = motorSpeed*(axial + lateral - yaw);
            ...
            */
            ...
            } else if (extendMotor.getCurrentPosition() >= 1750 && tiltMotor.getCurrentPosition()<1500 && gamepad2.right_stick_y<0.1 && Armstate != ArmState.Move) {
                extendMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                extendMotor.setPower(0);
            ...
            } else if (extendMotor.getCurrentPosition() >= 1500 && tiltMotor.getCurrentPosition()<1700 && gamepad2.left_stick_y>0.1 && Armstate != ArmState.Move) {
                tiltMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                tiltMotor.setPower(0);
            ...
            switch (Armstate) {
                case Start:
                    ...
                    if (gamepad2.y){
                        ...
                        extendMotor.setTargetPosition(3000);
                        Armstate = ArmState.Move;
                    }
                    ...
                    if (gamepad2.dpad_down) {
                        ...
                        tiltMotor.setPower(0.75);
                        extendMotor.setPower(0.75);
                        tiltMotor.setTargetPosition(1300);
                        extendMotor.setTargetPosition(0);
                        Armstate = ArmState.Move;
                    }
                    if (gamepad2.dpad_up){
                        ...
                        tiltMotor.setPower(0.75);
                        extendMotor.setPower(0.75);
                        tiltMotor.setTargetPosition(1800);
                        extendMotor.setTargetPosition(1200);
                        Armstate = ArmState.Move;
                    }
                    break;
                case Move:
